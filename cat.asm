...
cat(int fd)
{
  ...
  47:	68 9f 08 00 00       	push   $0x89f
  4c:	6a 01                	push   $0x1
  4e:	e8 96 04 00 00       	call   4e9 <printf>
...
main(int argc, char *argv[])
{
  ...
  ce:	50                   	push   %eax
  cf:	68 b0 08 00 00       	push   $0x8b0
  d4:	6a 01                	push   $0x1
  d6:	e8 0e 04 00 00       	call   4e9 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 488:	0f b6 91 34 0b 00 00 	movzbl 0xb34(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 546:	e8 cb fe ff ff       	call   416 <putc>
 ...
 570:	e8 c4 fe ff ff       	call   439 <printint>
 ...
 59a:	e8 9a fe ff ff       	call   439 <printint>
 ...
 5c1:	75 25                	jne    5e8 <printf+0xff>
          s = "(null)";
 5c3:	c7 45 f4 c5 08 00 00 	movl   $0x8c5,-0xc(%ebp)
        while(*s != 0){
 ...
 5dc:	e8 35 fe ff ff       	call   416 <putc>
 ...
 609:	e8 08 fe ff ff       	call   416 <putc>
 ...
 62a:	e8 e7 fd ff ff       	call   416 <putc>
 ...
 63c:	e8 d5 fd ff ff       	call   416 <putc>
 ...
 651:	e8 c0 fd ff ff       	call   416 <putc>
...
free(void *ap)
{
 ...
 754:	a3 68 0b 00 00       	mov    %eax,0xb68
}
 759:	90                   	nop
 75a:	c9                   	leave  
 75b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 77b:	50                   	push   %eax
 77c:	e8 6d fc ff ff       	call   3ee <sbrk>
 ...
 7b2:	83 c4 10             	add    $0x10,%esp
  return freep;
 7b5:	a1 68 0b 00 00       	mov    0xb68,%eax
}
 7ba:	c9                   	leave  
 7bb:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ce:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7d1:	a1 68 0b 00 00       	mov    0xb68,%eax
 7d6:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7d9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7dd:	75 23                	jne    802 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7df:	c7 45 f0 60 0b 00 00 	movl   $0xb60,-0x10(%ebp)
 7e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7e9:	a3 68 0b 00 00       	mov    %eax,0xb68
 7ee:	a1 68 0b 00 00       	mov    0xb68,%eax
 7f3:	a3 60 0b 00 00       	mov    %eax,0xb60
    base.s.size = 0;
 7f8:	c7 05 64 0b 00 00 00 	movl   $0x0,0xb64
 7ff:	00 00 00 
  }
 ...
 810:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 813:	77 4d                	ja     862 <malloc+0xa6>
      if(p->s.size == nunits)
 815:	8b 45 f4             	mov    -0xc(%ebp),%eax
 818:	8b 40 04             	mov    0x4(%eax),%eax
 81b:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 ...
 855:	a3 68 0b 00 00       	mov    %eax,0xb68
      return (void*)(p + 1);
 ...
 860:	eb 3b                	jmp    89d <malloc+0xe1>
    ...
    if(p == freep)
 862:	a1 68 0b 00 00       	mov    0xb68,%eax
